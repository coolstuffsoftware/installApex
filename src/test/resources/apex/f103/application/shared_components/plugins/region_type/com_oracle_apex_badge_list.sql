...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(2165048007577189235)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12751422371228492)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12751775317228492)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12752163212228492)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12752616728228493)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12753017772228493)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12753389456228493)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12753921509228494)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12754382082228494)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12754894794228494)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12755397325228494)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12755903778228495)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12756365988228495)
,p_plugin_attribute_id=>wwv_flow_api.id(12753017772228493)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12756858663228495)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
,p_default_value=>'L'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(12759761552228497)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12757228621228496)
,p_plugin_attribute_id=>wwv_flow_api.id(12756858663228495)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12757772168228496)
,p_plugin_attribute_id=>wwv_flow_api.id(12756858663228495)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12758284576228496)
,p_plugin_attribute_id=>wwv_flow_api.id(12756858663228495)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12758801457228496)
,p_plugin_attribute_id=>wwv_flow_api.id(12756858663228495)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12759300894228497)
,p_plugin_attribute_id=>wwv_flow_api.id(12756858663228495)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12759761552228497)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12760147471228497)
,p_plugin_attribute_id=>wwv_flow_api.id(12759761552228497)
,p_display_sequence=>10
,p_display_value=>'Rectangular'
,p_return_value=>'BOX'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12760650010228498)
,p_plugin_attribute_id=>wwv_flow_api.id(12759761552228497)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12761138811228498)
,p_plugin_id=>wwv_flow_api.id(2165048007577189235)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12761586648228498)
,p_plugin_attribute_id=>wwv_flow_api.id(12761138811228498)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12762077555228498)
,p_plugin_attribute_id=>wwv_flow_api.id(12761138811228498)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'

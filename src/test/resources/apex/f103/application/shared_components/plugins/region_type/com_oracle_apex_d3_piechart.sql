...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(2218252660483135594)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12351192712878989)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12351590665878989)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12352004034878989)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(12355388462878992)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12352326054878990)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12352726300878990)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12353216988878990)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
,p_unit=>'px'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(12365557537878998)
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'DONUT'
,p_help_text=>'Enter the radius of the hole inside the chart.'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12353538310878990)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12353882021878991)
,p_plugin_attribute_id=>wwv_flow_api.id(12353538310878990)
,p_display_sequence=>10
,p_display_value=>'Tooltip'
,p_return_value=>'TOOLTIP'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12354336136878991)
,p_plugin_attribute_id=>wwv_flow_api.id(12353538310878990)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12354855055878991)
,p_plugin_attribute_id=>wwv_flow_api.id(12353538310878990)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12355388462878992)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12355811213878992)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>5
,p_display_value=>'Theme'
,p_return_value=>'THEME'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12356302183878992)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12356800682878992)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12357230649878993)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12357747304878993)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12358301599878993)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12358814301878994)
,p_plugin_attribute_id=>wwv_flow_api.id(12355388462878992)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12359264758878994)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12359629466878994)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12360069283878995)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12360572489878995)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12361029299878995)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12361568352878996)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12362122065878996)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12362584419878996)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>60
,p_display_value=>'$14,435'
,p_return_value=>'$,.0f'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12363067736878996)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>70
,p_display_value=>'$14435'
,p_return_value=>'$.0f'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12363593211878997)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12364088620878997)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>90
,p_display_value=>'$14435.49'
,p_return_value=>'$.2f'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12364529517878997)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>100
,p_display_value=>'$14.4k'
,p_return_value=>'$.3s'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12365062515878998)
,p_plugin_attribute_id=>wwv_flow_api.id(12359629466878994)
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12365557537878998)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12365924158878998)
,p_plugin_attribute_id=>wwv_flow_api.id(12365557537878998)
,p_display_sequence=>10
,p_display_value=>'Pie'
,p_return_value=>'PIE'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12366440835878999)
,p_plugin_attribute_id=>wwv_flow_api.id(12365557537878998)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(12367011959878999)
,p_plugin_id=>wwv_flow_api.id(2218252660483135594)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(12353538310878990)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12367384250878999)
,p_plugin_attribute_id=>wwv_flow_api.id(12367011959878999)
,p_display_sequence=>10
,p_display_value=>'Above Chart'
,p_return_value=>'TOP'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(12367883165879000)
,p_plugin_attribute_id=>wwv_flow_api.id(12367011959878999)
,p_display_sequence=>20

...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(8768084504927699330)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2327328023913985514)
,p_plugin_id=>wwv_flow_api.id(8768084504927699330)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2327328486060985515)
,p_plugin_id=>wwv_flow_api.id(8768084504927699330)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2327328870670985515)
,p_plugin_id=>wwv_flow_api.id(8768084504927699330)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2327331674057985528)
,p_plugin_id=>wwv_flow_api.id(8768084504927699330)

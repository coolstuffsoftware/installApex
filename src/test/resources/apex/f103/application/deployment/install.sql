...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(7734825786495081307)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
,p_name=>'Drop Tables'
,p_sequence=>10
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(4115776734159415863)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666024427081871268)
,p_script_id=>wwv_flow_api.id(4115776734159415863)
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(7734739292120064025)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(4115777945521589448)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
,p_name=>'sample_pkg spec'
,p_sequence=>20
,p_script_type=>'UPGRADE'
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666024579119871268)
,p_script_id=>wwv_flow_api.id(4115777945521589448)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'SAMPLE_PKG'
,p_last_updated_on=>to_date('20141219062049','YYYYMMDDHH24MISS')
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(7734845462731083998)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
,p_name=>'Create Tables'
,p_sequence=>30
,p_script_type=>'UPGRADE'
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(4115776936368425925)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
...
begin
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666023530591871199)
,p_script_id=>wwv_flow_api.id(4115776936368425925)
,p_object_owner=>'#OWNER#'
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(939011557717895885)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
...
wwv_flow_api.append_to_install_script(
 p_id=>wwv_flow_api.id(939011557717895885)
,p_script_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'BC0D6ACA266842100A0DBD5D82FC214E1F101F2986E63FD634E'';',
...
begin
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666023790646871208)
,p_script_id=>wwv_flow_api.id(939011557717895885)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'SAMPLE_DATA_PKG'
,p_last_updated_on=>to_date('20141219062048','YYYYMMDDHH24MISS')
,p_created_on=>to_date('20141219062048','YYYYMMDDHH24MISS')
);
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(4115778122796592303)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
,p_name=>'sample_pkg body'
,p_sequence=>40
,p_script_type=>'UPGRADE'
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666023687930871199)
,p_script_id=>wwv_flow_api.id(4115778122796592303)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE BODY'
,p_object_name=>'SAMPLE_PKG'
,p_last_updated_on=>to_date('20141219062048','YYYYMMDDHH24MISS')
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(939111980274930817)
,p_install_id=>wwv_flow_api.id(7177471983864396611)
,p_name=>'sample_data_pkg'
,p_sequence=>50
,p_script_type=>'UPGRADE'
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(1666023902512871208)
,p_script_id=>wwv_flow_api.id(939111980274930817)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'SAMPLE_DATA_PKG'
,p_last_updated_on=>to_date('20141219062048','YYYYMMDDHH24MISS')
